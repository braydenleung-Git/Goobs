...
export const CHALLENGES: ChallengeDef[] = [
  ...
  { id: "build-script", title: "Build a Script", description: "Write and execute a script 2 times using agent tools", tier: 3, xpReward: 200, trigger: "counter", counterCheck: (c) => c.buildScriptCount >= 2 },
]
